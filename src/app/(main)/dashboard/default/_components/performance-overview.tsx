...
export function PerformanceOverview({
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle className="leading-none">Thông kê theo ngày</CardTitle>
      </CardHeader>
            ...
            <ComposedChart data={data} margin={{ top: 0, right: 8, left: 0 }}>
              <defs>
                ...
                <linearGradient id="fillOrders" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-orders)" stopOpacity={0.36} />
                  <stop offset="95%" stopColor="var(--color-orders)" stopOpacity={0.06} />
                </linearGradient>
              </defs>
